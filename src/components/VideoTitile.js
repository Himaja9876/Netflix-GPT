...
const VideoTitle = ({ title, description, movieId, playTrailer }) => {
  return (
    <div className="absolute z-5 w-screen aspect-video z-10 pt-[45%] md:pt-[18%] px-6 md:px-24 text-white ">
      ...
      <div className="my-4 md:m-0">
        <button
          onClick={() => playTrailer(movieId)}
          className=" bg-white text-black py-1 md:py-2.5 px-3 md:px-10 text-xl rounded-md hover:bg-opacity-80"
        >
          ▶︎ Play
        </button>
